...
const REFS: &[(f64, [f64; 4])] = &[
    (-30.0, [0.03222222222222232619581, 0.01559259259259258912681, 0.005035802469135802584662, 0.0002370768175582990399089]),
    (-7.5, [0.1155653881665804059304, 0.05125794824445594587595, 0.01538782912296142943876, 0.000643931777000795782615]),
    (-3.0, [0.2277541187075404381088, 0.09074862709748652063039, 0.02530601318972671534542, 0.0009599273914511165198619]),
    (-2.0, [0.2838338208091531729735, 0.1080830895954234135133, 0.02929178853562162657671, 0.001072947133905406644177]),
    (-1.0, [0.3678794411714423215955, 0.1321205588285576784045, 0.03454610783810898826219, 0.001212774504775654928857]),
    (-0.5, [0.4261226388505336944152, 0.1477547222989326111696, 0.03782388873546811099413, 0.001295554941872443976504]),
    (-0.01, [0.4983374916805357390598, 0.1662508319464260940228, 0.04158347202405726438467, 0.001386907239310513369891]),
    (0.01, [0.5016708416805754216546, 0.1670841680575421654569, 0.04175013908754987902362, 0.001390875498790236193367]),
    (0.5, [0.5948850828005125873946, 0.1897701656010251747892, 0.04620699786871701624508, 0.001494658141534731646984]),
    (1.0, [0.7182818284590452353603, 0.2182818284590452353603, 0.05161516179237856869362, 0.001615161792378568693621]),
    (1.9, [1.048724222238024768995, 0.2888022222305393521027, 0.06428187134940667654529, 0.001878634722827334223072]),
    (2.0, [1.097264024732662556808, 0.2986320123663312784038, 0.06598267284983230586857, 0.001912334879124743133809]),
    (2.1, [1.148791363394024959966, 0.3089482682828690285552, 0.06775314362676302947073, 0.001947046929727066395479]),
    (3.0, [1.787281880354185304548, 0.4290939601180617681825, 0.08747576448379836717196, 0.002312121979681300056143]),
    (7.5, [31.99186514588556812273, 4.198915352784742416365, 0.5376331581490767666264, 0.007706070959687290665951]),
    (30.0, [11873860646.10384682999, 395795354.8534615609996, 13193178.4895598298111, 14659.08688654795904937]),
];
...
fn low_orders_are_exp_and_expm1_over_x() {
    for &z in &[-3.0_f64, -0.25, 0.7, 4.0] {
        ...
        close("phi_1 is expm1/x", v.phi::<1>().extract::<0>(), (v.exp_m1() / v).extract::<0>(), 1e-15);
    }
...
fn recurrence_alone_loses_the_answer_below_the_split() {
    ...
    assert!(naive > 1e-10, "precondition: recurrence expected to be visibly wrong, rel {naive:e}");
