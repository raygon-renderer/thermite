...
decl!(u32x1: u32 => u32);
impl<S: Simd> Default for u32x1<S> {
    #[inline(always)]
    fn default() -> Self {
        Self::new(0)
    }
...
impl SimdVectorBase<Scalar> for u32x1<Scalar> {
    type Element = u32;
    ...
    decl_base_common!(#[target_feature()] u32x1: u32 => u32);
}

impl SimdBitwise<Scalar> for u32x1<Scalar> {
    const FULL_BITMASK: u16 = 1;

    fn bitmask(self) -> u16 {
        (self.value >> 31) as u16
    }
...
impl PartialEq<Self> for u32x1<Scalar> {
    #[inline(always)]
...
impl Eq for u32x1<Scalar> {}

impl SimdMask<Scalar> for u32x1<Scalar> {
    #[inline(always)]
...
impl SimdVector<Scalar> for u32x1<Scalar> {
    fn zero() -> Self {
        Self::new(0)
    }
    ...
    fn eq(self, other: Self) -> Mask<Scalar, Self> {
        Self::new(bool_to_u32(self.value == other.value))
    }
...
impl SimdIntVector<Scalar> for u32x1<Scalar> {
...
impl SimdUnsignedIntVector<Scalar> for u32x1<Scalar> {
    #[inline(always)]
...
impl_ops!(@UNARY u32x1 Scalar => Not::not);
impl_ops!(@BINARY u32x1 Scalar => Add::add, Sub::sub, Mul::mul, Div::div, Rem::rem, BitAnd::bitand, BitOr::bitor, BitXor::bitxor);
impl_ops!(@SHIFTS u32x1 Scalar => Shr::shr, Shl::shl);
