...
impl Register for F64x4V3 {
    ...
    unsafe fn store_masked(ptr: *mut Self::Element, mask: Storage<Self::Mask>, value: Storage<Self>) {
        unsafe { arch::_mm256_maskstore_pd(ptr, arch::_mm256_castpd_si256(mask), value) }
    }
    ...
    fn permutev(value: Storage<Self>, idxs: Storage<Self::Unsigned>) -> Storage<Self> {
        // As `I64x4V3::permutev`, through the pd wrapper.
        unsafe { arch::_mm256_permutevar4x64_pdx_v3(value, idxs) }
    }
