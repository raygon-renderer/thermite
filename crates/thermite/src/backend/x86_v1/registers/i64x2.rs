...
use crate::{
    ...
    isa::InstructionSet,
    register::{
        BitshiftRegister, BitwiseRegister, CastRegister, ConcatRegister, CoreRegister, ExtendRegister, IntegerRegister, InterleaveRegister, MaskElement, MaskRegister, NumericRegister,
        PartialOrdRegister, Register, ShuffleRegister, SignedIntegerRegister, SignedRegister, Storage,
...
impl MaskRegister for I64x2V1 {
    ...
    fn from_native_bitmask(bitmask: u64) -> Storage<Self> {
        unsafe { arch::_mm_movm_epi64x_v1(bitmask) }
    }
...
impl BitwiseRegister for I64x2V1 {
...
#[thermite_macros::inline_always]
impl ConcatRegister<i64> for I64x2V1 {
...
#[thermite_macros::inline_always]
impl ExtendRegister<i64> for I64x2V1 {
...
#[thermite_macros::inline_always]
impl InterleaveRegister for I64x2V1 {
...
#[thermite_macros::inline_always]
impl BitshiftRegister for I64x2V1 {
...
#[thermite_macros::inline_always]
impl ShuffleRegister for I64x2V1 {
...
impl PartialOrdRegister for I64x2V1 {
    fn gt(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_cmpgt_epi64x_v1(lhs, rhs) }
    }
...
#[thermite_macros::inline_always]
impl NumericRegister for I64x2V1 {
    sort_via_network!(2);
    ...
    fn min(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_min_epi64x_v1(lhs, rhs) }
    }

    fn max(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_max_epi64x_v1(lhs, rhs) }
    }
}

#[thermite_macros::inline_always]
impl SignedRegister for I64x2V1 {
    ...
    fn copysign(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_copysign_epi64x_v1(lhs, rhs) }
    }
    ...
    fn signum(value: Storage<Self>) -> Storage<Self> {
        ...
        unsafe {
            let lt = arch::_mm_cmpgt_epi64x_v1(Self::ZERO, value); // -1 where value < 0
            let gt = arch::_mm_cmpgt_epi64x_v1(value, Self::ZERO); // -1 where value > 0
...
#[thermite_macros::inline_always]
impl IntegerRegister for I64x2V1 {
    ...
    fn saturating_add(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_adds_epi64x_v1(lhs, rhs) }
    }

    fn saturating_sub(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_subs_epi64x_v1(lhs, rhs) }
    }
    ...
    fn leading_zeros(value: Storage<Self>) -> Storage<Self> {
        ...
        Self::sub(Self::splat(64), super::U64x2V1::ilog2p1(value))
    }
...
#[thermite_macros::inline_always]
impl SignedIntegerRegister for I64x2V1 {
...
#[thermite_macros::inline_always]
impl CastRegister<ArrayRegister<super::I64x2V1, 2>> for super::I32x4V1 {
    fn cast_from(value: Storage<ArrayRegister<super::I64x2V1, 2>>) -> Storage<Self> {
        let (lo, hi) = <ArrayRegister<super::I64x2V1, 2> as ConcatRegister<super::I64x2V1>>::split(value);
        unsafe { arch::_mm_cvtepi64_epi32x_v1(lo, hi) }
    }
}

#[thermite_macros::inline_always]
impl CastRegister<<Scalar as Simd>::i32x2> for I64x2V1 {
    fn cast_from(value: Storage<<Scalar as Simd>::i32x2>) -> Storage<Self> {
        unsafe { arch::_mm_cvtepi32_epi64x_v1(arch::_mm_setr_epi32(value.0[0], value.0[1], 0, 0)) }
    }
}

#[thermite_macros::inline_always]
impl CastRegister<I64x2V1> for <Scalar as Simd>::i32x2 {
    fn cast_from(value: Storage<I64x2V1>) -> Storage<<Scalar as Simd>::i32x2> {
        unsafe {
            ArrayRegister([
                arch::_mm_cvtsi128_si32(value),          // lowest 32 bits
                arch::_mm_extract_epi32x_v1::<2>(value), // next 32 bits after 64 bits
            ])
        }
    }
}
