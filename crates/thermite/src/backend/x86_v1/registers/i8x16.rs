//! Native 128-bit signed 8-bit register for x86-v1 (SSE2). Byte add/sub/sat/compare/bitwise
//! are native SSE2; the missing ops (8-bit shift/multiply, unsigned compare, signed min/max)
//! use SSE2 polyfills, and the genuinely awkward ones (reductions, signum, narrow cast,
//! reverse, deinterleave, variable permute) fall back to scalar - x86-v1 is for completeness,
//! not speed.
...
#[thermite_macros::inline_always]
impl InterleaveRegister for I8x16V1 {
    fn interleave(a: Storage<Self>, b: Storage<Self>) -> (Storage<Self>, Storage<Self>) {
        unsafe { (arch::_mm_unpacklo_epi8(a, b), arch::_mm_unpackhi_epi8(a, b)) }
    }

    fn deinterleave(a: Storage<Self>, b: Storage<Self>) -> (Storage<Self>, Storage<Self>) {
        // SSE2 has no `pshufb`; gather even/odd byte lanes scalar-wise.
        let mut ax = [0i8; 16];
        let mut bx = [0i8; 16];
        unsafe {
        ...
        let cat: [i8; 32] = core::array::from_fn(|i| if i < 16 { ax[i] } else { bx[i - 16] });
        let evens: [i8; 16] = core::array::from_fn(|i| cat[2 * i]);
        let odds: [i8; 16] = core::array::from_fn(|i| cat[2 * i + 1]);
        unsafe {
            (
...
impl BitwiseRegister for I8x16V1 {
...
#[thermite_macros::inline_always]
impl ExtendRegister<i8> for I8x16V1 {
    ...
    fn narrow(value: Storage<Self>) -> Storage<i8> {
        // no `_mm_extract_epi8` before SSE4.1; read lane 0 from the stored array.
        Self::as_array(&value)[0]
    }
}

#[thermite_macros::inline_always]
impl Register for I8x16V1 {
    type Element = i8;
    ...
    fn msb_to_mask(value: Storage<Self>) -> Storage<Self::Mask> {
        // Smear bit 7 of each byte: 0 > value (signed) iff the byte's MSB is set.
...
#[rustfmt::skip] #[thermite_macros::inline_always]
impl BitshiftRegister for I8x16V1 {
...
#[thermite_macros::inline_always]
impl NumericRegister for I8x16V1 {
    ...
    fn min(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_min_epi8x_v1(lhs, rhs) }
    }
    fn max(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_max_epi8x_v1(lhs, rhs) }
    }
}

#[thermite_macros::inline_always]
impl SignedRegister for I8x16V1 {
    const NEG_ONE: Storage<Self> = reg::<Self, 16>([-1; 16]);
    const MIN_POSITIVE: Storage<Self> = reg_splat::<Self>(1);

    fn neg(value: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm_sub_epi8(arch::_mm_setzero_si128(), value) }
    }
    ...
    fn abs(value: Storage<Self>) -> Storage<Self> {
        ...
        unsafe { arch::_mm_max_epi8x_v1(value, arch::_mm_sub_epi8(arch::_mm_setzero_si128(), value)) }
    }
...
#[thermite_macros::inline_always]
impl IntegerRegister for I8x16V1 {
    ...
    fn leading_zeros(value: Storage<Self>) -> Storage<Self> {
        super::U8x16V1::leading_zeros(value)
    }
...
#[thermite_macros::inline_always]
impl SignedIntegerRegister for I8x16V1 {
...
// Saturating narrow i16x16 -> i8x16 via a single two-source SSE2 `packsswb`.
#[thermite_macros::inline_always]
impl SaturatingCastRegister<ArrayRegister<super::I16x8V1, 2>> for I8x16V1 {
    fn saturating_cast_from(value: Storage<ArrayRegister<super::I16x8V1, 2>>) -> Storage<Self> {
        unsafe { arch::_mm_packs_epi16(value.0[0], value.0[1]) }
    }
}

// Saturating narrow i32x16 -> i8x16: three SSE2 `packssdw`/`packsswb`, no clamp.
#[thermite_macros::inline_always]
impl SaturatingCastRegister<ArrayRegister<super::I32x4V1, 4>> for I8x16V1 {
    fn saturating_cast_from(value: Storage<ArrayRegister<super::I32x4V1, 4>>) -> Storage<Self> {
        unsafe {
            let w0 = arch::_mm_packs_epi32(value.0[0], value.0[1]);
            let w1 = arch::_mm_packs_epi32(value.0[2], value.0[3]);
            arch::_mm_packs_epi16(w0, w1)
        }
    }
}
...
#[thermite_macros::inline_always]
impl SaturatingCastRegister<ArrayRegister<super::I64x2V1, 8>> for I8x16V1 {
    fn saturating_cast_from(value: Storage<ArrayRegister<super::I64x2V1, 8>>) -> Storage<Self> {
        type Src = ArrayRegister<super::I64x2V1, 8>;
