...
use crate::{
    ...
    register::{
        ...
        FloatRegister, MaskElement, MaskRegister, NumericRegister, PartialOrdRegister, PermuteRegister, Register,
        ShuffleRegister, SignedRegister, Storage, SwizzleRegister, ZeroUpper, dp::DoublePumpRegister, empty_reg, reg,
    },
    simd::Simd,
};
