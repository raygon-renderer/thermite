...
use crate::{
    isa::InstructionSet,
    register::{
        BitwiseRegister, BlendRegister, CastRegister, CoreRegister, ExtendRegister, FloatRegister, InterleaveRegister,
...
impl FloatRegister for F32x4V2 {
    ...
    // fmsubadd are a plain multiply followed by the native addsub (2 instructions,
    // cheaper than the generic xor + mul_adde emulation).
