...
impl_has_isa!(
    X86V2: F32x4V2, I32x4V2, U32x4V2, F64x2V2, I64x2V2, U64x2V2, I16x8V2, U16x8V2, I8x16V2, U8x16V2
);
...
impl_cast_via! {
    ArrayRegister<U64x2V2, 2> as F32x4V2 => via ArrayRegister<F64x2V2, 2>,
}
...
impl_sign_cast_matrix_8_16_to_32_64! {
    [ArrayRegister<I32x4V2, 2>, ArrayRegister<U32x4V2, 2>, ArrayRegister<I64x2V2, 4>, ArrayRegister<U64x2V2, 4>,
        I16x8V2, U16x8V2, half8::I8x8V2, half8::U8x8V2],
}
...
impl_cast_from_via! {
    ArrayRegister<I16x8V2, 2> as ArrayRegister<U64x2V2, 8> => via ArrayRegister<I64x2V2, 8>,
    ArrayRegister<U16x8V2, 2> as ArrayRegister<I64x2V2, 8> => via ArrayRegister<U64x2V2, 8>,
    ArrayRegister<I64x2V2, 8> as ArrayRegister<U16x8V2, 2> => via ArrayRegister<I16x8V2, 2>,
    ArrayRegister<U64x2V2, 8> as ArrayRegister<I16x8V2, 2> => via ArrayRegister<U16x8V2, 2>,
}
...
impl_cast_from_via! {
    I64x2V2 as half::F32x2V2 => via F64x2V2,
    U64x2V2 as half::F32x2V2 => via F64x2V2,
    ArrayRegister<I64x2V2, 2> as F32x4V2 => via ArrayRegister<F64x2V2, 2>,
}
...
#[thermite_macros::inline_always]
impl crate::register::CastRegister<I32x4V2> for ArrayRegister<F64x2V2, 2> {
...
#[thermite_macros::inline_always]
impl crate::register::CastRegister<U32x4V2> for ArrayRegister<F64x2V2, 2> {
...
impl_sign_cast_matrix_8_to_32_64! {
    [ArrayRegister<I32x4V2, 4>, ArrayRegister<U32x4V2, 4>, ArrayRegister<I64x2V2, 8>, ArrayRegister<U64x2V2, 8>,
        I8x16V2, U8x16V2],
}
...
impl_sign_cast_matrix_8_16! {
    [half16::I16x4V2, half16::U16x4V2, half8::I8x4V2, half8::U8x4V2],
    [I16x8V2, U16x8V2, half8::I8x8V2, half8::U8x8V2],
    [ArrayRegister<I16x8V2, 2>, ArrayRegister<U16x8V2, 2>, I8x16V2, U8x16V2],
}
