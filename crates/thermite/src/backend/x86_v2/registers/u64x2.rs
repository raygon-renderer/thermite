...
use crate::{
    ...
    register::{
        ...
        SignedRegister, Storage, UnsignedIntegerRegister, array::ArrayRegister, empty_reg, reg,
    },
    simd::Simd,
};
...
#[thermite_macros::inline_always]
impl InterleaveRegister for U64x2V2 {
...
impl Register for U64x2V2 {
    ...
    fn permutev(value: Storage<Self>, idxs: Storage<Self::Unsigned>) -> Storage<Self> {
        ...
        unsafe { arch::_mm_permutevarx_epi64x_v2(value, idxs) }
    }
