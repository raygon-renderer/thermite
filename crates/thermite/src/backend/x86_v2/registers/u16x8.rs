...
impl CoreRegister for U16x8V2 {
    ...
    fn zeroupper_z<Z: crate::register::ZeroUpper>(value: Storage<Self>) -> Storage<Self> {
        super::I16x8V2::zeroupper_z::<Z>(value) // same mask layout
    }
...
#[thermite_macros::inline_always]
impl InterleaveRegister for U16x8V2 {
    fn interleave(a: Storage<Self>, b: Storage<Self>) -> (Storage<Self>, Storage<Self>) {
        super::I16x8V2::interleave(a, b)
    }

    fn deinterleave(a: Storage<Self>, b: Storage<Self>) -> (Storage<Self>, Storage<Self>) {
        super::I16x8V2::deinterleave(a, b)
    }
}

#[thermite_macros::inline_always]
impl MaskRegister for U16x8V2 {
...
impl BitwiseRegister for U16x8V2 {
...
#[thermite_macros::inline_always]
impl ExtendRegister<u16> for U16x8V2 {
...
#[rustfmt::skip] #[thermite_macros::inline_always]
impl BitshiftRegister for U16x8V2 {
...
#[thermite_macros::inline_always]
impl PartialOrdRegister for U16x8V2 {
...
#[thermite_macros::inline_always]
impl NumericRegister for U16x8V2 {
    sort_via_network!(8);
...
#[thermite_macros::inline_always]
impl IntegerRegister for U16x8V2 {
    ...
    fn trailing_zeros(value: Storage<Self>) -> Storage<Self> {
        super::I16x8V2::trailing_zeros(value)
    }
}
...
#[thermite_macros::inline_always]
impl CastRegister<U16x8V2> for ArrayRegister<super::U32x4V2, 2> {
    fn cast_from(value: Storage<U16x8V2>) -> Storage<Self> {
        unsafe {
            let lo = arch::_mm_cvtepu16_epi32(value);
            let hi = arch::_mm_cvtepu16_epi32(arch::_mm_srli_si128(value, 8));
            ArrayRegister([lo, hi])
        }
    }
}
