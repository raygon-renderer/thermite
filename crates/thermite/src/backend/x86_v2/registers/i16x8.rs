...
impl CoreRegister for I16x8V2 {
    ...
    fn zeroupper_z<Z: ZeroUpper>(value: Storage<Self>) -> Storage<Self> {
        if const { Z::N >= 8 } {
            ...
            // Zero the upper (8 - N) 16-bit lanes by masking.
            let mut arr = [0i16; 8];
...
#[thermite_macros::inline_always]
impl InterleaveRegister for I16x8V2 {
    fn interleave(a: Storage<Self>, b: Storage<Self>) -> (Storage<Self>, Storage<Self>) {
        unsafe { (arch::_mm_unpacklo_epi16(a, b), arch::_mm_unpackhi_epi16(a, b)) }
    }

    fn deinterleave(a: Storage<Self>, b: Storage<Self>) -> (Storage<Self>, Storage<Self>) {
        // One `pshufb` per input groups even words into the low 64 bits and odd words into the
        // high 64 bits; `unpacklo/hi_epi64` then merges the two inputs:
        //   evens = [a0 a2 a4 a6 | b0 b2 b4 b6],  odds = [a1 a3 a5 a7 | b1 b3 b5 b7].
        unsafe {
...
impl MaskRegister for I16x8V2 {
    ...
    fn all(value: Storage<Self>) -> bool {
        // movemask_epi8 yields 2 bits per 16-bit lane; all set => 0xFFFF.
...
impl BitwiseRegister for I16x8V2 {
...
#[thermite_macros::inline_always]
impl ExtendRegister<i16> for I16x8V2 {
...
impl Register for I16x8V2 {
    ...
    fn reverse(value: Storage<Self>) -> Storage<Self> {
        // Reverse the 8 16-bit lanes: byte shuffle [14,15, 12,13, ..., 0,1].
        unsafe {
...
#[rustfmt::skip] #[thermite_macros::inline_always]
impl BitshiftRegister for I16x8V2 {
    ...
    fn shlv(value: Storage<Self>, shifts: Storage<Self::Unsigned>) -> Storage<Self> {
        unsafe { arch::_mm_sllv_epi16x_v1(value, shifts) }
    }
    fn shrv(value: Storage<Self>, shifts: Storage<Self::Unsigned>) -> Storage<Self> {
        unsafe { arch::_mm_srlv_epi16x_v1(value, shifts) }
    }
}

#[thermite_macros::inline_always]
impl PartialOrdRegister for I16x8V2 {
...
#[thermite_macros::inline_always]
impl SignedRegister for I16x8V2 {
...
#[thermite_macros::inline_always]
impl IntegerRegister for I16x8V2 {
    ...
    fn leading_zeros(value: Storage<Self>) -> Storage<Self> {
        // treat as unsigned
        super::U16x8V2::leading_zeros(value)
    }
...
#[thermite_macros::inline_always]
impl SignedIntegerRegister for I16x8V2 {
    ...
    fn srav(value: Storage<Self>, shifts: Storage<Self::Unsigned>) -> Storage<Self> {
        unsafe { arch::_mm_srav_epi16x_v1(value, shifts) }
    }
...
// Widen i16x8 -> i32x8 (= ArrayRegister<I32x4V2, 2>): sign-extend the low/high 4 lanes.
#[thermite_macros::inline_always]
impl CastRegister<I16x8V2> for ArrayRegister<super::I32x4V2, 2> {
    fn cast_from(value: Storage<I16x8V2>) -> Storage<Self> {
        unsafe {
            let lo = arch::_mm_cvtepi16_epi32(value);
            let hi = arch::_mm_cvtepi16_epi32(arch::_mm_srli_si128(value, 8));
            ArrayRegister([lo, hi])
        }
    }
}
...
impl CastRegister<ArrayRegister<super::I32x4V2, 2>> for I16x8V2 {
    ...
    fn cast_from(value: Storage<ArrayRegister<super::I32x4V2, 2>>) -> Storage<Self> {
        unsafe {
            ...
            let lo = arch::_mm_shuffle_epi8(value.0[0], pick_lo16);
            let hi = arch::_mm_shuffle_epi8(value.0[1], pick_lo16);
            // lo holds 4 packed i16 in its low 64 bits, hi likewise -> merge into 8 lanes.
