...
impl BitshiftRegister for I32x4V2 {
    ...
    fn rolv(value: Self::Storage, shifts: Storage<Self::UCOUNT>) -> Self::Storage {
        unsafe { arch::_mm_rolv_epi32x_v2(value, shifts) }
    }

    #[inline(always)]
    fn rorv(value: Self::Storage, shifts: Storage<Self::UCOUNT>) -> Self::Storage {
        unsafe { arch::_mm_rorv_epi32x_v2(value, shifts) }
    }

    #[inline(always)]
    fn rol(value: Self::Storage, shift: u32) -> Self::Storage {
        unsafe { arch::_mm_rolv_epi32x_v2(value, arch::_mm_set1_epi32(shift as i32)) }
    }

    #[inline(always)]
    fn ror(value: Self::Storage, shift: u32) -> Self::Storage {
        unsafe { arch::_mm_rorv_epi32x_v2(value, arch::_mm_set1_epi32(shift as i32)) }
    }
...
impl IntegerRegister for I32x4V2 {
    ...
    fn divv_branchfree(value: Self::Storage, dividers: crate::divider::vector::VectorDivider<Self>) -> Self::Storage {
        unsafe { arch::_mm_divv_epi32x_bf_v1(value, dividers.multipliers.0, dividers.shifts.0) }
    }
...
impl CastRegister<I32x4V2> for DoublePumpRegister<super::I64x2V2> {
    fn cast_from(value: <I32x4V2 as Register>::Storage) -> Self::Storage {
        unsafe {
