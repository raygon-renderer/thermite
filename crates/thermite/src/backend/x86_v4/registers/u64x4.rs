//! `u64x4` on AVX-512: the 256-bit unsigned-qword register under EVEX
//! (AVX512VL). The width port of [`u64x8`](super::u64x8). See that file and
//! [`i64x4`](super::i64x4).
...
impl BitwiseRegister for U64x4V4 {
...
#[thermite_macros::inline_always]
impl crate::register::ConcatRegister<super::U64x2V4> for U64x4V4 {
    fn concat(lo: Storage<super::U64x2V4>, hi: Storage<super::U64x2V4>) -> Storage<Self> {
        unsafe { arch::_mm256_setr_m128i(lo, hi) }
    }

    fn split(value: Storage<Self>) -> (Storage<super::U64x2V4>, Storage<super::U64x2V4>) {
...
#[thermite_macros::inline_always]
impl crate::register::ExtendRegister<super::U64x2V4> for U64x4V4 {
    fn extend(value: Storage<super::U64x2V4>) -> Storage<Self> {
        unsafe { arch::_mm256_zextsi128_si256(value) }
    }

    fn narrow(value: Storage<Self>) -> Storage<super::U64x2V4> {
        unsafe { arch::_mm256_castsi256_si128(value) }
    }
}

#[thermite_macros::inline_always]
impl crate::register::WideRegister for U64x4V4 {
    type Wide = super::U64x8V4;
}

#[thermite_macros::inline_always]
impl Register for U64x4V4 {
    type Element = u64;

    type Signed = super::I64x4V4;
    type Unsigned = U64x4V4;
    ...
    fn single(value: Self::Element) -> Storage<Self> {
        unsafe { arch::_mm256_zextsi128_si256(arch::_mm_cvtsi64x_si128(value as i64)) }
    }
    ...
    unsafe fn load_m(src: Storage<Self>, mask: Storage<Self::Mask>, ptr: *const Self::Element) -> Storage<Self> {
        unsafe { arch::_mm256_mask_loadu_epi64(src, mask, ptr as *const _) }
    }

    unsafe fn load_z(mask: Storage<Self::Mask>, ptr: *const Self::Element) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_loadu_epi64(mask, ptr as *const _) }
    }
    ...
    unsafe fn store_masked(ptr: *mut Self::Element, mask: Storage<Self::Mask>, value: Storage<Self>) {
        unsafe { arch::_mm256_mask_storeu_epi64(ptr as *mut _, mask, value) }
    }
    ...
    fn new_m(
        ...
        unsafe { arch::_mm256_mask_loadu_epi64(src, mask, value.as_ptr() as *const _) }
    }

    fn new_z(mask: Storage<Self::Mask>, value: GenericArray<Self::Element, Self::Lanes>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_loadu_epi64(mask, value.as_ptr() as *const _) }
    }

    fn splat_m(src: Storage<Self>, mask: Storage<Self::Mask>, value: Self::Element) -> Storage<Self> {
        unsafe { arch::_mm256_mask_set1_epi64(src, mask, value as i64) }
    }

    fn splat_z(mask: Storage<Self::Mask>, value: Self::Element) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_set1_epi64(mask, value as i64) }
    }
...
#[thermite_macros::inline_always]
impl InterleaveRegister for U64x4V4 {
...
#[thermite_macros::inline_always]
impl IndexableRegister<U64x4V4> for U64x4V4 {
    unsafe fn gather(ptr: *const Self::Element, indices: Storage<U64x4V4>) -> Storage<Self> {
        unsafe { arch::_mm256_i64gather_epi64::<8>(ptr as _, indices) }
    }
    ...
    unsafe fn gather_m(
        ...
        indices: Storage<U64x4V4>,
    ) -> Storage<Self> {
        unsafe { arch::_mm256_mmask_i64gather_epi64::<8>(src, mask, indices, ptr as _) }
    }

    unsafe fn scatter(value: Storage<Self>, ptr: *mut Self::Element, indices: Storage<U64x4V4>) {
        unsafe { arch::_mm256_i64scatter_epi64::<8>(ptr as _, indices, value) }
    }
    ...
    unsafe fn scatter_m(
        ...
        unsafe { arch::_mm256_mask_i64scatter_epi64::<8>(ptr as _, mask, indices, value) }
    }
}

// Four 32-bit indices are one xmm (`u32x4`): vpgatherdq / vpscatterdq.
#[thermite_macros::inline_always]
impl IndexableRegister<super::U32x4V4> for U64x4V4 {
    unsafe fn gather(ptr: *const Self::Element, indices: Storage<super::U32x4V4>) -> Storage<Self> {
        unsafe { arch::_mm256_i32gather_epi64::<8>(ptr as _, indices) }
    }
    ...
    unsafe fn gather_m(
        ...
        unsafe { arch::_mm256_mmask_i32gather_epi64::<8>(src, mask, indices, ptr as _) }
    }

    unsafe fn scatter(value: Storage<Self>, ptr: *mut Self::Element, indices: Storage<super::U32x4V4>) {
        unsafe { arch::_mm256_i32scatter_epi64::<8>(ptr as _, indices, value) }
    }
    ...
    unsafe fn scatter_m(
        ...
        unsafe { arch::_mm256_mask_i32scatter_epi64::<8>(ptr as _, mask, indices, value) }
    }
}

#[thermite_macros::inline_always]
impl BitshiftRegister for U64x4V4 {
...
impl NumericRegister for U64x4V4 {
    ...
    fn min_element(value: Storage<Self>) -> Self::Element {
        _mm256_reduce_epi64_v3!(value; _mm_min_epu64 _mm_min_epu64) as u64
    }

    fn max_element(value: Storage<Self>) -> Self::Element {
        _mm256_reduce_epi64_v3!(value; _mm_max_epu64 _mm_max_epu64) as u64
    }
    ...
    fn prod_elements(value: Storage<Self>) -> Self::Element {
        _mm256_reduce_epi64_v3!(value; _mm_mullo_epi64 _mm_mullo_epi64) as u64
    }
    ...
    fn min(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_min_epu64(lhs, rhs) }
    }

    fn max(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_max_epu64(lhs, rhs) }
    }
    ...
    masked_binary_v4! {
        ...
        min => _mm256_mask_min_epu64, _mm256_maskz_min_epu64;
        max => _mm256_mask_max_epu64, _mm256_maskz_max_epu64;
    }
...
#[thermite_macros::inline_always]
impl IntegerRegister for U64x4V4 {
    fn mulhi(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe {
            let lomask = arch::_mm256_set1_epi64x(0xFFFF_FFFF);
            let xh = arch::_mm256_shuffle_epi32::<0b10_11_00_01>(lhs);
            let yh = arch::_mm256_shuffle_epi32::<0b10_11_00_01>(rhs);
            ...
            let w0h = arch::_mm256_srli_epi64::<32>(w0);
            let s1 = arch::_mm256_add_epi64(w1, w0h);
            let s1l = arch::_mm256_and_si256(s1, lomask);
            let s1h = arch::_mm256_srli_epi64::<32>(s1);
            let s2 = arch::_mm256_add_epi64(w2, s1l);
            let s2h = arch::_mm256_srli_epi64::<32>(s2);

            arch::_mm256_add_epi64(arch::_mm256_add_epi64(w3, s1h), s2h)
        }
    }
    ...
    fn saturating_add_c(mask: Storage<Self::Mask>, lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_add_epi64(lhs, mask, lhs, Self::min(rhs, Self::not(lhs))) }
    }
    ...
    fn saturating_add_m(
        ...
        unsafe { arch::_mm256_mask_add_epi64(src, mask, lhs, Self::min(rhs, Self::not(lhs))) }
    }

    fn saturating_add_z(mask: Storage<Self::Mask>, lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_add_epi64(mask, lhs, Self::min(rhs, Self::not(lhs))) }
    }

    fn saturating_sub_c(mask: Storage<Self::Mask>, lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi64(lhs, mask, Self::max(lhs, rhs), rhs) }
    }
    ...
    fn saturating_sub_m(
        ...
        unsafe { arch::_mm256_mask_sub_epi64(src, mask, Self::max(lhs, rhs), rhs) }
    }

    fn saturating_sub_z(mask: Storage<Self::Mask>, lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_sub_epi64(mask, Self::max(lhs, rhs), rhs) }
    }
...
#[thermite_macros::inline_always]
impl UnsignedIntegerRegister for U64x4V4 {
    ...
    /// 2D Morton via the 256-bit carry-less multiply (`vpclmulqdq`, tier 2).
    /// Otherwise, and for every other `N`, the generic cascade.
    fn morton<const N: usize>(values: [Storage<Self>; N]) -> Storage<Self> {
        if const { N == 2 && <F as Avx512Features>::VPCLMULQDQ } {
            unsafe {
                let lomask = arch::_mm256_set1_epi64x(0xFFFF_FFFF);

                let x = arch::_mm256_and_si256(values[0], lomask);
                let y = arch::_mm256_and_si256(values[1], lomask);

                let xs = arch::_mm256_unpacklo_epi64(
                    arch::_mm256_clmulepi64_epi128::<0x00>(x, x),
                    arch::_mm256_clmulepi64_epi128::<0x11>(x, x),
                );
                let ys = arch::_mm256_unpacklo_epi64(
                    arch::_mm256_clmulepi64_epi128::<0x00>(y, y),
                    arch::_mm256_clmulepi64_epi128::<0x11>(y, y),
                );

                arch::_mm256_or_si256(xs, arch::_mm256_slli_epi64::<1>(ys))
            }
        } else {
    ...
    fn ilog2p1_c(mask: Storage<Self::Mask>, value: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi64(value, mask, Self::splat(64), Self::leading_zeros(value)) }
    }

    fn ilog2p1_m(src: Storage<Self>, mask: Storage<Self::Mask>, value: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi64(src, mask, Self::splat(64), Self::leading_zeros(value)) }
    }

    fn ilog2p1_z(mask: Storage<Self::Mask>, value: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_sub_epi64(mask, Self::splat(64), Self::leading_zeros(value)) }
    }

    fn avg_c(mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi64(a, mask, Self::bitor(a, b), Self::shri::<1>(Self::bitxor(a, b))) }
    }

    fn avg_m(src: Storage<Self>, mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi64(src, mask, Self::bitor(a, b), Self::shri::<1>(Self::bitxor(a, b))) }
    }

    fn avg_z(mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_sub_epi64(mask, Self::bitor(a, b), Self::shri::<1>(Self::bitxor(a, b))) }
    }

    fn abs_diff_c(mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi64(a, mask, Self::max(a, b), Self::min(a, b)) }
    }

    fn abs_diff_m(src: Storage<Self>, mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi64(src, mask, Self::max(a, b), Self::min(a, b)) }
    }

    fn abs_diff_z(mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_sub_epi64(mask, Self::max(a, b), Self::min(a, b)) }
    }
