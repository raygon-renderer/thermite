//! `i32x8` on AVX-512: the 256-bit signed-dword register under EVEX
//! (AVX512VL). The width port of [`i32x16`](super::i32x16). See that file
//! for the integer notes and [`f32x16`](super::f32x16) for the house rules.
//!
//! Width-only differences: `KMask8`, the v3 `_mm256_reduce_epi32_v3!` fold
//! for element reductions (no 256-bit reduce sequences in `core::arch`),
//! `count_ones`'s tier-1 fallback is the inherited same-width v3 LUT, and
//! the widen/narrow legs to `i64x8` are single zmm converts.
...
impl BitwiseRegister for I32x8V4 {
...
#[thermite_macros::inline_always]
impl crate::register::ConcatRegister<super::I32x4V4> for I32x8V4 {
    fn concat(lo: Storage<super::I32x4V4>, hi: Storage<super::I32x4V4>) -> Storage<Self> {
        unsafe { arch::_mm256_setr_m128i(lo, hi) }
    }

    fn split(value: Storage<Self>) -> (Storage<super::I32x4V4>, Storage<super::I32x4V4>) {
...
#[thermite_macros::inline_always]
impl crate::register::ExtendRegister<super::I32x4V4> for I32x8V4 {
    fn extend(value: Storage<super::I32x4V4>) -> Storage<Self> {
        unsafe { arch::_mm256_zextsi128_si256(value) }
    }

    fn narrow(value: Storage<Self>) -> Storage<super::I32x4V4> {
        unsafe { arch::_mm256_castsi256_si128(value) }
    }
}

#[thermite_macros::inline_always]
impl crate::register::WideRegister for I32x8V4 {
    type Wide = super::I32x16V4;
}

#[thermite_macros::inline_always]
impl Register for I32x8V4 {
    type Element = i32;
    ...
    fn single(value: Self::Element) -> Storage<Self> {
        unsafe { arch::_mm256_zextsi128_si256(arch::_mm_cvtsi32_si128(value)) }
    }
    ...
    unsafe fn load_m(src: Storage<Self>, mask: Storage<Self::Mask>, ptr: *const Self::Element) -> Storage<Self> {
        unsafe { arch::_mm256_mask_loadu_epi32(src, mask, ptr) }
    }

    unsafe fn load_z(mask: Storage<Self::Mask>, ptr: *const Self::Element) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_loadu_epi32(mask, ptr) }
    }
    ...
    unsafe fn store_masked(ptr: *mut Self::Element, mask: Storage<Self::Mask>, value: Storage<Self>) {
        unsafe { arch::_mm256_mask_storeu_epi32(ptr, mask, value) }
    }
...
#[thermite_macros::inline_always]
impl InterleaveRegister for I32x8V4 {
...
#[thermite_macros::inline_always]
impl IndexableRegister<super::U32x8V4> for I32x8V4 {
    ...
    unsafe fn gather_m(
        ...
        unsafe { arch::_mm256_mmask_i32gather_epi32::<4>(src, mask, indices, ptr) }
    }

    unsafe fn scatter(value: Storage<Self>, ptr: *mut Self::Element, indices: Storage<super::U32x8V4>) {
        unsafe { arch::_mm256_i32scatter_epi32::<4>(ptr, indices, value) }
    }
    ...
    unsafe fn scatter_m(
        ...
        unsafe { arch::_mm256_mask_i32scatter_epi32::<4>(ptr, mask, indices, value) }
    }
}

// Eight 64-bit indices are one zmm (`u64x8`).
#[thermite_macros::inline_always]
impl IndexableRegister<super::U64x8V4> for I32x8V4 {
    unsafe fn gather(ptr: *const Self::Element, indices: Storage<super::U64x8V4>) -> Storage<Self> {
        unsafe { arch::_mm512_i64gather_epi32::<4>(indices, ptr) }
    }
    ...
    unsafe fn gather_m(
        ...
        unsafe { arch::_mm512_mask_i64gather_epi32::<4>(src, mask, indices, ptr) }
    }

    unsafe fn scatter(value: Storage<Self>, ptr: *mut Self::Element, indices: Storage<super::U64x8V4>) {
        unsafe { arch::_mm512_i64scatter_epi32::<4>(ptr, indices, value) }
    }
    ...
    unsafe fn scatter_m(
        ...
        unsafe { arch::_mm512_mask_i64scatter_epi32::<4>(ptr, mask, indices, value) }
    }
}

#[thermite_macros::inline_always]
impl BitshiftRegister for I32x8V4 {
...
#[thermite_macros::inline_always]
impl ShuffleRegister for I32x8V4 {
...
impl NumericRegister for I32x8V4 {
    ...
    masked_binary_v4! {
        ...
        min => _mm256_mask_min_epi32, _mm256_maskz_min_epi32;
        max => _mm256_mask_max_epi32, _mm256_maskz_max_epi32;
    }
...
#[thermite_macros::inline_always]
impl SignedRegister for I32x8V4 {
    ...
    fn neg_c(mask: Storage<Self::Mask>, value: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi32(value, mask, Self::ZERO, value) }
    }

    fn neg_m(src: Storage<Self>, mask: Storage<Self::Mask>, value: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi32(src, mask, Self::ZERO, value) }
    }

    fn neg_z(mask: Storage<Self::Mask>, value: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_sub_epi32(mask, Self::ZERO, value) }
    }

    masked_unary_v4! {
        abs => _mm256_mask_abs_epi32, _mm256_maskz_abs_epi32;
    }
    ...
    fn copysign_m(
        ...
        unsafe { arch::_mm256_mask_mov_epi32(src, mask, Self::copysign(lhs, rhs)) }
    }

    fn copysign_z(mask: Storage<Self::Mask>, lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_mov_epi32(mask, Self::copysign(lhs, rhs)) }
    }
}

#[thermite_macros::inline_always]
impl IntegerRegister for I32x8V4 {
    fn mulhi(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe {
            let even_hi = arch::_mm256_srli_epi64::<32>(arch::_mm256_mul_epi32(lhs, rhs));
            let odd_hi = arch::_mm256_mul_epi32(arch::_mm256_srli_epi64::<32>(lhs), arch::_mm256_srli_epi64::<32>(rhs));
    ...
    fn saturating_add(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        // Overflow iff operands agree in sign and the sum does not: ternlog
        // 0x42 + vpmovd2m, saturated value MAX ^ (l >> 31), masked move.
        unsafe {
            let sum = Self::add(lhs, rhs);
            let ov = arch::_mm256_movepi32_mask(arch::_mm256_ternarylogic_epi32::<
                { crate::ternlog_imm!((A ^ C) & (B ^ C)) },
            >(lhs, rhs, sum));
            let sat = Self::bitxor(Self::MAX, Self::srai::<31>(lhs));
            arch::_mm256_mask_mov_epi32(sum, ov, sat)
        }
    }
    ...
    fn saturating_sub(lhs: Storage<Self>, rhs: Storage<Self>) -> Storage<Self> {
        unsafe {
            ...
            >(lhs, rhs, diff));
            let sat = Self::bitxor(Self::MAX, Self::srai::<31>(lhs));
            arch::_mm256_mask_mov_epi32(diff, ov, sat)
        }
    }
    ...
    fn count_ones(value: Storage<Self>) -> Storage<Self> {
        if const { <F as Avx512Features>::AVX512VPOPCNTDQ } {
            ...
            // Same-width v3 LUT port, not a half-split.
...
#[thermite_macros::inline_always]
impl SignedIntegerRegister for I32x8V4 {
    fn srai<const IMM8: i32>(value: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_sra_epi32(value, arch::_mm_cvtsi32_si128(IMM8)) }
    }
    ...
    masked_shift_v4! {
        sra => _mm256_mask_sra_epi32, _mm256_maskz_sra_epi32;
    }

    masked_shifti_v4! {
        srai => _mm256_mask_sra_epi32, _mm256_maskz_sra_epi32;
    }

    masked_binary_v4! {
        srav(Storage<Self::Unsigned>) => _mm256_mask_srav_epi32, _mm256_maskz_srav_epi32;
    }

    fn avg_floor_c(mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_add_epi32(a, mask, Self::bitand(a, b), Self::srai::<1>(Self::bitxor(a, b))) }
    }

    fn avg_floor_m(src: Storage<Self>, mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_add_epi32(src, mask, Self::bitand(a, b), Self::srai::<1>(Self::bitxor(a, b))) }
    }

    fn avg_floor_z(mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_add_epi32(mask, Self::bitand(a, b), Self::srai::<1>(Self::bitxor(a, b))) }
    }

    fn avg_ceil_c(mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi32(a, mask, Self::bitor(a, b), Self::srai::<1>(Self::bitxor(a, b))) }
    }

    fn avg_ceil_m(src: Storage<Self>, mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_mask_sub_epi32(src, mask, Self::bitor(a, b), Self::srai::<1>(Self::bitxor(a, b))) }
    }

    fn avg_ceil_z(mask: Storage<Self::Mask>, a: Storage<Self>, b: Storage<Self>) -> Storage<Self> {
        unsafe { arch::_mm256_maskz_sub_epi32(mask, Self::bitor(a, b), Self::srai::<1>(Self::bitxor(a, b))) }
    }
...
// Widen/narrow legs against the native i64x8: single zmm converts.
#[thermite_macros::inline_always]
impl CastRegister<I32x8V4> for super::I64x8V4 {
    fn cast_from(value: Storage<I32x8V4>) -> Storage<Self> {
        unsafe { arch::_mm512_cvtepi32_epi64(value) }
    }
}

#[thermite_macros::inline_always]
impl CastRegister<super::I64x8V4> for I32x8V4 {
    ...
    fn saturating_cast_from(value: Storage<super::I64x8V4>) -> Storage<Self> {
        unsafe { arch::_mm512_cvtsepi64_epi32(value) }
    }
}
