...
pub trait NativeSimd {
    ...
    type f32xN: Interoperable<Self::i32xN, Self::u32xN, Lanes = Self::Native32Width, Element = f32, UCOUNT = Self::u32xN, SCOUNT = Self::i32xN>
        + FloatRegister;
    type i32xN: Interoperable<Self::f32xN, Self::u32xN, Lanes = Self::Native32Width, Element = i32, UCOUNT = Self::u32xN, SCOUNT = Self::i32xN>
        + IntegerRegister + SignedRegister;
    type u32xN: Interoperable<Self::f32xN, Self::i32xN, Lanes = Self::Native32Width, Element = u32, UCOUNT = Self::u32xN, SCOUNT = Self::i32xN>
        + UnsignedIntegerRegister;

    // Largest Native 64-bit SIMD types
    type f64xN: Interoperable<Self::i64xN, Self::u64xN, Lanes = Self::Native64Width, Element = f64, UCOUNT = Self::u64xN, SCOUNT = Self::i64xN>
        + FloatRegister;
    type i64xN: Interoperable<Self::f64xN, Self::u64xN, Lanes = Self::Native64Width, Element = i64, UCOUNT = Self::u64xN, SCOUNT = Self::i64xN>
        + IntegerRegister + SignedRegister;
    type u64xN: Interoperable<Self::f64xN, Self::i64xN, Lanes = Self::Native64Width, Element = u64, UCOUNT = Self::u64xN, SCOUNT = Self::i64xN>
        + UnsignedIntegerRegister;
}
...
pub trait Simd: NativeSimd {
    ...
    type f32x4: Interoperable<Self::i32x4, Self::u32x4, Lanes = U4, Element = f32, UCOUNT = Self::u32x4, SCOUNT = Self::i32x4>
        + FloatRegister<Bits = Self::u32x4, Signed = Self::i32x4> + CastRegister<Self::f64x4>;
    type i32x4: Interoperable<Self::f32x4, Self::u32x4, Lanes = U4, Element = i32, UCOUNT = Self::u32x4, SCOUNT = Self::i32x4>
        + SignedIntegerRegister + CastRegister<Self::i64x4>;
    type u32x4: Interoperable<Self::f32x4, Self::i32x4, Lanes = U4, Element = u32, UCOUNT = Self::u32x4, SCOUNT = Self::i32x4>
        + UnsignedIntegerRegister + CastRegister<Self::u64x4>;

    // 256/32-bit SIMD types
    type f32x8: Interoperable<Self::i32x8, Self::u32x8, Lanes = U8, Element = f32, UCOUNT = Self::u32x8, SCOUNT = Self::i32x8>
        + FloatRegister<Bits = Self::u32x8, Signed = Self::i32x8> + CastRegister<Self::f64x8>;
    type i32x8: Interoperable<Self::f32x8, Self::u32x8, Lanes = U8, Element = i32, UCOUNT = Self::u32x8, SCOUNT = Self::i32x8>
        + SignedIntegerRegister + CastRegister<Self::i64x8>;
    type u32x8: Interoperable<Self::f32x8, Self::i32x8, Lanes = U8, Element = u32, UCOUNT = Self::u32x8, SCOUNT = Self::i32x8>
        + UnsignedIntegerRegister + CastRegister<Self::u64x8>;

    // 128/64-bit SIMD types
    type f64x2: Interoperable<Self::i64x2, Self::u64x2, Lanes = U2, Element = f64, UCOUNT = Self::u64x2, SCOUNT = Self::i64x2>
        + FloatRegister<Bits = Self::u64x2, Signed = Self::i64x2>;
    type i64x2: Interoperable<Self::f64x2, Self::u64x2, Lanes = U2, Element = i64, UCOUNT = Self::u64x2, SCOUNT = Self::i64x2>
        + SignedIntegerRegister;
    type u64x2: Interoperable<Self::f64x2, Self::i64x2, Lanes = U2, Element = u64, UCOUNT = Self::u64x2, SCOUNT = Self::i64x2>
        + UnsignedIntegerRegister;

    // 256/64-bit SIMD types
    type f64x4: Interoperable<Self::i64x4, Self::u64x4, Lanes = U4, Element = f64, UCOUNT = Self::u64x4, SCOUNT = Self::i64x4>
        + FloatRegister<Bits = Self::u64x4, Signed = Self::i64x4> + CastRegister<Self::f32x4>;
    type i64x4: Interoperable<Self::f64x4, Self::u64x4, Lanes = U4, Element = i64, UCOUNT = Self::u64x4, SCOUNT = Self::i64x4>
        + SignedIntegerRegister + CastRegister<Self::i32x4>;
    type u64x4: Interoperable<Self::f64x4, Self::i64x4, Lanes = U4, Element = u64, UCOUNT = Self::u64x4, SCOUNT = Self::i64x4>
        + UnsignedIntegerRegister + CastRegister<Self::u32x4>;

    // 512/64-bit SIMD types
    type f64x8: Interoperable<Self::i64x8, Self::u64x8, Lanes = U8, Element = f64, UCOUNT = Self::u64x8, SCOUNT = Self::i64x8>
        + FloatRegister<Bits = Self::u64x8, Signed = Self::i64x8> + CastRegister<Self::f32x8>;
    type i64x8: Interoperable<Self::f64x8, Self::u64x8, Lanes = U8, Element = i64, UCOUNT = Self::u64x8, SCOUNT = Self::i64x8>
