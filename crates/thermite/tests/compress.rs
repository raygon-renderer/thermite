...
check!(compress_f32x4, f32x4, 4);
check!(compress_i32x4, i32x4, 4);
check!(compress_u32x4, u32x4, 4);
check!(compress_f32x8, f32x8, 8);
check!(compress_f64x4, f64x4, 4);
check!(compress_i64x2, i64x2, 2);
