    ...
    unsafe {
        ...
        for trial in 0..4096 {
            ...
            let pairs: [(__m256i, __m256i, &str); 3] = [
                (
                    arch::_mm256_sllv_epi16x_v3(a, b),
                    arch::_mm256_sllv_epi16_widex_v3(a, b),
                    "sllv",
                ),
                (
                    arch::_mm256_srlv_epi16x_v3(a, b),
                    arch::_mm256_srlv_epi16_widex_v3(a, b),
                    "srlv",
                ),
                (
                    arch::_mm256_srav_epi16x_v3(a, b),
                    arch::_mm256_srav_epi16_widex_v3(a, b),
                    "srav",
                ),
            ];
            ...
            let pairs128: [(__m128i, __m128i, &str); 3] = [
                (
                    arch::_mm_sllv_epi16x_v1(a4, b4),
                    arch::_mm_sllv_epi16_widex_v3(a4, b4),
                    "sllv",
                ),
                (
                    arch::_mm_srlv_epi16x_v1(a4, b4),
                    arch::_mm_srlv_epi16_widex_v3(a4, b4),
                    "srlv",
                ),
                (
                    arch::_mm_srav_epi16x_v1(a4, b4),
                    arch::_mm_srav_epi16_widex_v3(a4, b4),
                    "srav",
                ),
            ];
