...
macro_rules! suite {
    ($modname:ident, $backend:ty) => {
        mod $modname {
            use super::*;
            check!(u8x16, thermite::simd::u8x16<$backend>, u8, 16, [0, 1, 2, 7, 8, 15, 16]);
            check!(i8x16, thermite::simd::i8x16<$backend>, i8, 16, [0, 1, 2, 7, 8, 15, 16]);
            check!(u16x8, thermite::simd::u16x8<$backend>, u16, 8, [0, 1, 4, 7, 8]);
            check!(u16x16, thermite::simd::u16x16<$backend>, u16, 16, [0, 1, 8, 15, 16]);
            ...
            check!(i16x16, thermite::simd::i16x16<$backend>, i16, 16, [0, 1, 8, 15, 16]);
...
mod v3_native_bytes {
    use super::*;
    check!(i8xN, thermite::simd::i8xN<X86V3>, i8, 32, [0, 1, 2, 3, 15, 16, 17, 18, 31, 32]);
    check!(u8xN, thermite::simd::u8xN<X86V3>, u8, 32, [0, 1, 2, 3, 15, 16, 17, 18, 31, 32]);
}
