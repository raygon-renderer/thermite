...
#[rustfmt::skip]
macro_rules! log_reduce_ps_avx1 {
...
impl SimdVectorBase<AVX1> for f32x8<AVX1> {
    type Element = f32;
    ...
    decl_base_common!(#[target_feature(enable = "avx,fma")] f32x8: f32 => __m256);
}

impl SimdBitwise<AVX1> for f32x8<AVX1> {
...
impl PartialEq<Self> for f32x8<AVX1> {
...
impl SimdMask<AVX1> for f32x8<AVX1> {
    #[inline(always)]
...
impl SimdVector<AVX1> for f32x8<AVX1> {
    #[inline(always)]
    fn zero() -> Self {
        Self::new(unsafe { _mm256_setzero_ps() })
    }
    ...
    fn min_element(self) -> Self::Element {
        log_reduce_ps_avx1!(self.value; _mm_min_ps _mm_min_ss)
    }

    #[inline(always)]
    fn max_element(self) -> Self::Element {
        log_reduce_ps_avx1!(self.value; _mm_max_ps _mm_max_ss)
    }
...
impl SimdIntoBits<AVX1, Vu32> for f32x8<AVX1> {
    #[inline(always)]
...
impl SimdFromBits<AVX1, Vu32> for f32x8<AVX1> {
    #[inline(always)]
...
impl SimdSignedVector<AVX1> for f32x8<AVX1> {
    #[inline(always)]
    fn neg_one() -> Self {
        Self::splat(-1.0)
    }
...
impl SimdFloatVector<AVX1> for f32x8<AVX1> {
    type Vu = Vu32;
    type Vi = Vi32;
    ...
    fn sum(self) -> Self::Element {
        log_reduce_ps_avx1!(self.value; _mm_add_ps _mm_add_ss)
    }

    #[inline(always)]
    fn product(self) -> Self::Element {
        log_reduce_ps_avx1!(self.value; _mm_mul_ps _mm_mul_ss)
    }
...
impl_ops!(@UNARY f32x8 AVX1 => Not::not, Neg::neg);
impl_ops!(@BINARY f32x8 AVX1 => Add::add, Sub::sub, Mul::mul, Div::div, Rem::rem, BitAnd::bitand, BitOr::bitor, BitXor::bitxor);
impl_ops!(@SHIFTS f32x8 AVX1 => Shr::shr, Shl::shl);

impl SimdFromCast<AVX1, Vi32> for f32x8<AVX1> {
    #[inline(always)]
...
impl SimdFromCast<AVX1, Vu32> for f32x8<AVX1> {
    #[inline(always)]
...
impl SimdFromCast<AVX1, Vu64> for f32x8<AVX1> {
    #[inline]
    fn from_cast(from: Vu64) -> Self {
        decl_brute_force_convert!(#[target_feature(enable = "avx")] u64 => f32);
...
impl SimdFromCast<AVX1, Vf64> for f32x8<AVX1> {
    #[inline(always)]
...
impl SimdFromCast<AVX1, Vi64> for f32x8<AVX1> {
    #[inline(always)]
