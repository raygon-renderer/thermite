...
impl SimdCastFrom<AVX1, Vi32> for f32x8<AVX1> {
    #[inline(always)]
...
impl SimdCastFrom<AVX1, Vu64> for f32x8<AVX1> {
    #[inline]
...
impl SimdCastFrom<AVX1, Vf64> for f32x8<AVX1> {
    #[inline(always)]
...
impl SimdCastFrom<AVX1, Vi64> for f32x8<AVX1> {
    #[inline(always)]
