...
impl SimdCastFrom<AVX1, Vf32> for i64x8<AVX1> {
    #[inline(always)]
...
impl SimdCastFrom<AVX1, Vi32> for i64x8<AVX1> {
    #[inline(always)]
...
impl SimdCastFrom<AVX1, Vu32> for i64x8<AVX1> {
    #[inline(always)]
...
impl SimdCastFrom<AVX1, Vu64> for i64x8<AVX1> {
    #[inline(always)]
